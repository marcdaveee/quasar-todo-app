  ...
  <div>
    <div class="bg-white q-pa-lg">
      ...
      <q-input
        ...
        autogrow
        type="textarea"
        class="onboarding-input-field autogrow standard onboarding-border-accent-0 onboarding-border-radius-10 q-pr-md"
      />
      <div class="q-py-md"></div>
      <Filters />
      <div class="q-py-md"></div>
      ...
      <div class="flex justify-start items-center">
        ...
        <q-select
          ...
          v-model="page"
          :options="pageOptions"
          class="onboarding-select-field onboarding-border-radius-50 height-31 min-width-90 onboarding-border-accent-0 text-center text-15 q-ml-md"
        ...
        >
          ...
          <div class="q-mt-md">
            ...
            <q-select
              ...
              option-value="id"
              multiple
              class="onboarding-border-radius-10 onboarding-border-accent-0 onboarding-select-field standard_q-chip use-input"
              dense
              borderless
              use-input
              use-chips
            ...
            >
            <q-select
              class="onboarding-border-radius-10 onboarding-border-accent-0 onboarding-select-field standard full-width standard_q-chip"
              dense
              borderless
              map-options
              ref="milestoneRef"
            ...
            >
              ...
              <template v-slot:before-options>
                <div class="q-px-md q-pt-md q-pb-sm">
                  <q-input
                    class="minmax-width onboarding-border-radius-8 onboarding-border-accent-0 onboarding-select-field height-31 use-input q-px-sm full-width"
                    dense
                    autofocus
                    borderless
                    debounce="500"
                  ...
                  >
                    <template v-slot:prepend>
                      <q-icon
                        class="onboarding-text-accent-0 q-mr-sm"
                        name="search"
                      />
                    </template>
                  </q-input>
      ...
      <div class="standard-form-width">
        ...
        <!-- Start to copy here -->
        <q-card
          class="onboarding-border-radius-12 no-shadow onboarding-border-accent-0 q-pa-md q-mb-md"
        >
      ...
      <div
        class="chart pm-bg-primary relative-position onboarding-border-accent-0 q-pa-md onboarding-border-radius-15"
      >
      ...
      <!-- **************************Menu******************************* -->
      <hr class="q-my-md q-mt-xl" />
      <h4 class="onboarding-bg-accent-1 text-white q-pa-sm">
        Menu w/ expansion
      </h4>
      <div class="standard-form-width">
        <!-- Start to copy here -->
        <q-expansion-item>
          <template v-slot:header>
            ...
            <q-item-section class="list-text pm-text-primary">
              Settings
            </q-item-section>
          </template>
